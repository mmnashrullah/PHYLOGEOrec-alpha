...
/***************************************************************************
 ...
 Modified from the original module of settingsdialog.py of Qgis2threejs plugin
...
class SettingsDialog(QDialog):
    ...
    def __init__(self, parent):
        ...
        ui.lineEdit_BrowserPath.setText(settings.value("/PhyloGeoRec/browser", "", type=unicode))
        enabled_plugins = QSettings().value("/PhyloGeoRec/plugins", "", type=unicode).split(",")
        #ui.lineEdit_BrowserPath.setText(settings.value("/PhyloGeoRec/browser", "", type="UTF-8"))
        #enabled_plugins = QSettings().value("/PhyloGeoRec/plugins", "", type="UTF-8").split(",")
    ...
    def accept(self):
        ...
        # general settings
        settings.setValue("/PhyloGeoRec/browser", self.ui.lineEdit_BrowserPath.text())
        ...
        settings.setValue("/PhyloGeoRec/plugins", ",".join(enabled_plugins))
