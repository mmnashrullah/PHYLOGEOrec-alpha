...
/***************************************************************************
 ...
 Modified from the original module of exportsettings.py of Qgis2threejs plugin
...
class ExportSettings:
    ...
    def controls(self):
        ...
        return QSettings().value("/PhyloGeoRec/lastControls", def_vals.controls, type=unicode)
